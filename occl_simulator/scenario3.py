...
"""
Scenario 3: Pedestrian Crossing Between Two Trucks
...
class Scenario3:
    ...
    def __init__(self, world, blueprint_library):
        ...
        self.config = ScenarioConfig('scenario3')
...
def main():
    ...
    print("Use 'python main.py scenario3' to run with a controller.")
