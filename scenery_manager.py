...
class SceneryManager:
    ...
    def spawn_ego_vehicle(self, vehicle_config):
        ...
        # Create spawn point from config
        ...
        for i, truck_pos in enumerate(vehicle_config['trucks']):
            ...
            if 'type' in truck_pos:
                ...
                try:
                    ...
                    truck_blueprints = [bp for bp in self.blueprint_library.filter('vehicle.*') 
            ...
            try:
                ...
                print(f"Truck {i+1} spawned at ({truck_location.x:.1f}, {truck_location.y:.1f}, {truck_location.z:.1f}): {truck_bp.id}")
            except Exception as e:
                print(f"Failed to spawn truck {i+1}: {e}")
    
    def spawn_static_vehicles(self, config_list):
        """Spawn additional static vehicles for scenery"""
    ...
    def get_actor_count(self):
        """Get count of spawned scenery actors"""
